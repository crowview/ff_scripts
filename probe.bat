...
ffprobe -v error -show_entries stream=index,codec_type,width,height,sample_aspect_ratio,display_aspect_ratio,r_frame_rate,avg_frame_rate,bit_rate -select_streams v -unit "%1"
)